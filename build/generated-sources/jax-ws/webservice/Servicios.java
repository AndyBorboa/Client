...
public interface Servicios {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "listarClave", targetNamespace = "http://WebService/", className = "webservice.ListarClave")
    @ResponseWrapper(localName = "listarClaveResponse", targetNamespace = "http://WebService/", className = "webservice.ListarClaveResponse")
    @Action(input = "http://WebService/Servicios/listarClaveRequest", output = "http://WebService/Servicios/listarClaveResponse")
    public Producto listarClave(
